/*******************************************************************************
* Class Name: EnumString
* Date Created: N/A
* Inheritance: None
* Description: Enum helper class to convert Enums to const std::string &.
*
*  Credit: Francies Xavier Joseph Pulikotil
*  Notes: A utility to provide stringizing support for C++ enums
