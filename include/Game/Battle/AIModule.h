...
//   std::vector<BattleActor*> friend_targets;
//   std::vector<BattleActor*> foe_targets;
...
//   bool setFriendTargets(std::vector<BattleActor*> new_valid_targets);

//   /* Assigns the vector of valid foe targets */
//   bool setFoeTargets(std::vector<BattleActor*> new_valid_targets);
