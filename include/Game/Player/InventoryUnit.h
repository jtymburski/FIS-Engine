/********************************************************************************
* Class Name: InventoryUnit
* Date Created: Oct 28 2012
* Inheritance: QWidget
* Description: The InventoryUnit class
* TODO: Add bool private data for status ailments
********************************************************************************/
#ifndef INVENTORYUNIT_H
#define INVENTORYUNIT_H
#include <QtGui/QWidget>
#include <QImage>
#include <QString>
#include "Person.h"

class InventoryUnit : public QWidget
{
public:
  /*Constructor function*/
  InventoryUnit(QWidget *parent = 0);
